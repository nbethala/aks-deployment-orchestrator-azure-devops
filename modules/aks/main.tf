...
# Kubernetes Version: dynamically pulls the latest stable AKS version for your region
...
resource "azurerm_kubernetes_cluster" "aks-cluster" {
  ...
  # Default Node Pool for HA, AS & VMSS
  default_node_pool {
...
# upload the key to key vault
  ...
  # Network Profile - azure CNI and standard load-balancer 
  network_profile {
